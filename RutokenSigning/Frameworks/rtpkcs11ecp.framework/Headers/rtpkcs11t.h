...
#define CKA_VENDOR_SUPPORT_HW_RESULT_FOR_GOST28147_KEY_UNWRAP (CKA_VENDOR_DEFINED | 0x300C)

#define CKA_VENDOR_SUPPORT_HW_KDF_TREE              (CKA_VENDOR_DEFINED | 0x300D)

#define CKA_VENDOR_SUPPORT_KIMP15                   (CKA_VENDOR_DEFINED | 0x300E)
...
typedef struct CK_TOKEN_INFO_EXTENDED {
  ...
  /* Token current battery charge percentage */
...
#define INTERFACE_TYPE_SPI      0x00000040
